...
public:
	...
	// If no such data was found, an exception is thrown.
	...
	virtual void generalOrderTraverse(void visit(ItemType&)) const = 0;
	virtual void linearOrderTraverse(void visit(ItemType&)) const = 0;
